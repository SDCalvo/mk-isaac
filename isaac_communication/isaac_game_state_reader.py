...
class IsaacGameStateReader:
    ...
    def __init__(self):
        ...
        # Mod directory
        self.mod_dir = (
            "E:/Steam/steamapps/common/The Binding of Isaac Rebirth/mods/IsaacGameStateReader"
        )
    ...
    def _initialize(self):
        ...
        print(
            "Failed to connect to the mod. Make sure the game is running with the --luadebug option."
        )
        print("\nTROUBLESHOOTING:")
        ...
        try:
            ...
            if response.strip().startswith("Error:"):
                ...
                return {
                    ...
                    "frame": None,
                    "player": {"health": {"current": 0, "max": 0}, "position": {"x": 0, "y": 0}},
                    "enemies": [],
            ...
            try:
                ...
                print(
                    f"Room type: {room.get('type', 'Unknown')}, Name: {room.get('type_name', 'Unknown')}"
                )
    ...
    def _parse_status_text(self, response):
        ...
        game_state = {
            ...
            "frame": None,
            "player": {"health": {"current": 0, "max": 0}, "position": {"x": 0, "y": 0}},
            "floor": {"name": None, "stage": None},
            "enemies": [],
            "room": {"type": 0, "type_name": "UNKNOWN", "is_clear": False},
        ...
        try:
            ...
            for line in lines:
                if line.startswith("Time:"):
                    ...
                    game_state["room"]["is_clear"] = (
                        line.replace("Room Clear:", "").strip().lower() == "true"
                    )
    ...
    def get_nearest_enemy(self):
        ...
        for enemy in enemies:
            ...
            dist = (
                (enemy_pos.get("x") - player_pos.get("x")) ** 2
                + (enemy_pos.get("y") - player_pos.get("y")) ** 2
            ) ** 0.5
    ...
    def get_nearest_pickup(self):
        ...
        for pickup in pickups:
            ...
            dist = (
                (pickup_pos.get("x") - player_pos.get("x")) ** 2
                + (pickup_pos.get("y") - player_pos.get("y")) ** 2
            ) ** 0.5
