...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("play.log"), logging.StreamHandler()],
)
...
def visualize_state(state, action, q_values=None, reward=None):
    ...
    # Add text for action
    cv2.putText(
        vis_frame, f"Action: {action_name}", (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1
    )
