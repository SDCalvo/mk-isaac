...
def parse_args():
    ...
    parser.add_argument("--save_interval", type=int, default=50, help="Number of episodes between model saves")
...
def train(args):
    ...
    for episode in range(1, args.episodes + 1):
        ...
        logging.info(f"Episode {episode} - Reward: {episode_reward:.2f}, Steps: {step}, "
